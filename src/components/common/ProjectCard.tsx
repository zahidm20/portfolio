...
export default function ProjectCard({
  ...
  return (
    ...
    >
      ...
      <div className="dark:bg-dark-secondary absolute bottom-0 h-10 w-full overflow-y-auto border-t-2 border-black-primary bg-yellow-primary p-2 transition-all duration-300 group-hover:h-[60%] lg:group-hover:h-2/4">
        <div className="flex h-full flex-col justify-between">
          ...
          <div className="flex-1 overflow-y-auto">
            <p className="text-xs font-normal text-black-primary group-hover:block">
              {description}
            </p>
            <p className="whitespace-pre-line text-xs font-normal text-black-primary group-hover:block">
              {techstack}
            </p>
          </div>
        </div>
