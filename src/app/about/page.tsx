    ...
    <section className="text-black-primary">
      ...
      <div className="mx-auto mb-12 mt-8 flex flex-col items-center justify-center md:gap-10 lg:flex-row">
        ...
        <p className="mt-5 text-justify text-base text-secondary-text md:mt-0 lg:w-1/2 xl:text-lg">
          I am a Vocational High School Informatics Engineering student at SMK
          Madinatul Quran. I have a strong understanding of programming
          languages and web development, as well as hands-on experience in{' '}
          <b>software development</b> projects. My current focus is to deepen my
          knowledge in the field of <b>web & android development</b>.
          <br />
          <br />I have hands-on experience with <b>ReactJS</b> and <b>NextJS</b>{' '}
          for the frontend, and using <b>ExpressJS</b> and <b>Nest.Js</b> for
          backend development. I am also learning <b>Flutter</b> for android
          development.
        </p>
      </div>
      <TextSection
